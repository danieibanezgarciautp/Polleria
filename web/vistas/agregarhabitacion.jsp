    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row align-items-start">
                <div class="col-9"><h1>Habitaciones</h1></div>
            ...
            <div class="table-responsive">
                <table class="table table-striped" id="mydataTable">
                    ...
                    <tbody>
                        <%
                        ArrayList<Habitacion> listaHabitacion = habitacionDAO.mostrarHabitaciones("General",false);
                        
                        for (Habitacion elem : listaHabitacion) {     
                            
                        %>
                        <tr data-descripcion="<%= elem.getDescripcionHabitacion() %>">
