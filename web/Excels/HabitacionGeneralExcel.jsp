...
try {
    ...
    String sql = "SELECT * FROM Habitacion INNER JOIN Pisohabitacion ON Habitacion.idPisohabitacion=Pisohabitacion.idPisohabitacion INNER JOIN Categoriahabitacion ON Habitacion.idCategoriahabitacion=Categoriahabitacion.idCategoriahabitacion;";
    stmt = conn.prepareStatement(sql);
    rs = stmt.executeQuery();

    // Crear el libro de Excel
    HSSFWorkbook workbook = new HSSFWorkbook();
    HSSFSheet sheet = workbook.createSheet("Habitacion General");
